...
public class TextEditor {
    ...
    private HashMap<String,int[]> fillSymbols5x8() {
        ...
        symbols.put(ACTION_KEY, Symbol.action.pixels);
        symbols.put(TURN_KEY, Symbol.turn.pixels);
        symbols.put(OVERHEAT_INACTIVE_KEY, Symbol.overheat_inactive.pixels);
        symbols.put(LIFE, Symbol.life.pixels);
        symbols.put(MANA, Symbol.hypermatter.pixels);
        symbols.put(FAITH, Symbol.energy.pixels);
    ...
    private int getTextWidth(String text) {
        ...
        return text.length() - (int)count*4;
    }
