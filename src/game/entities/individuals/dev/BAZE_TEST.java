...
public class BAZE_TEST extends Entity {
    ...
    static int[][] idleR = SpriteLibrary.setupSprites(new Point[]{new Point(0,0),new Point(1,0), new Point(2,0), new Point(3,0),
            ...
            64,64,"res/sprites/characters/baze/baze_idle.png",false);
    static int[][] idleL = SpriteLibrary.setupSprites(new Point[]{new Point(0,0),new Point(1,0), new Point(2,0), new Point(3,0),
                    new Point(4,0),new Point(5,0), new Point(6,0), new Point(7,0),
                    new Point(8,0),new Point(9,0)},
            64,64,"res/sprites/characters/baze/baze_idle.png",true);
    static int[][] aaR = SpriteLibrary.setupSprites(new Point[]{new Point(0,0),new Point(1,0), new Point(2,0), new Point(3,0),
                    new Point(4,0),new Point(5,0), new Point(6,0), new Point(7,0),new Point(8,0)},
            64,64,"res/sprites/characters/baze/baze_aa.png",false);
    ...
    public BAZE_TEST(Arena arena, boolean enemy, int position) {
    ...
    private Animator getAnimator() {
        ...
        idleLAnimation.images.put(180,idleL[2]);
        idleLAnimation.images.put(240,idleL[3]);
        idleLAnimation.images.put(300,idleL[4]);
        idleLAnimation.images.put(320,idleL[5]);
        idleLAnimation.images.put(330,idleL[6]);
        idleLAnimation.images.put(340,idleL[7]);
        idleLAnimation.images.put(350,idleL[8]);
        idleLAnimation.images.put(360,idleL[9]);
        idleLAnimation.length = 360;
        Animation idleRAnimation = new Animation();
        idleRAnimation.images.put(60,idleR[0]);
        idleRAnimation.images.put(120,idleR[1]);
        idleRAnimation.images.put(180,idleR[2]);
        idleRAnimation.images.put(240,idleR[3]);
        idleRAnimation.images.put(300,idleR[4]);
        idleRAnimation.images.put(320,idleR[5]);
        idleRAnimation.images.put(330,idleR[6]);
        idleRAnimation.images.put(340,idleR[7]);
        idleRAnimation.images.put(350,idleR[8]);
        idleRAnimation.images.put(360,idleR[9]);
        idleRAnimation.length = 360;
        ...
        runRAnimation.images.put(10,aaR[0]);
        runRAnimation.images.put(20,aaR[1]);
        runRAnimation.images.put(30,aaR[2]);
        runRAnimation.images.put(32,aaR[3]);
        runRAnimation.images.put(34,aaR[4]);
        runRAnimation.images.put(36,aaR[5]);
        runRAnimation.images.put(38,aaR[6]);
        runRAnimation.images.put(48,aaR[7]);
        runRAnimation.images.put(58,aaR[8]);
        runRAnimation.length = 58;
