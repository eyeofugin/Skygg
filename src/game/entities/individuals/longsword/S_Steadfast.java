...
public class S_Steadfast extends Skill {
    ...
    public S_Steadfast(Hero hero) {
        super(hero);
        this.iconPath = "/res/icons/steadfast.png";
        addSubscriptions();
        setToInitial();
        initAnimation();
    }
    ...
    public String getDescriptionFor(Hero hero) {
        return "Get 2 Steadfast stack, when get damage. sot lose a stack. Steadfast: 10% dmg reduction";
    }
    ...
    public void dmgTrigger(DmgTriggerPayload pl) {
        if (this.hero.equals(pl.target)) {
            this.hero.addEffect(new Steadfast(1), this.hero);
        }
    }
