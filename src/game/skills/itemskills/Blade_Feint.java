...
public class Blade_Feint extends Skill {
    ...
    public Skill getCast() {
        Blade_Feint cast = new Blade_Feint(this.Hero);
        cast.copyFrom(this);
        return cast;
    }
    ...
    protected void individualResolve(Hero target) {
        ...
        this.Hero.removePermanentEffect(OffensiveStance.class);
        this.Hero.addEffect(new DefensiveStance(), null);
