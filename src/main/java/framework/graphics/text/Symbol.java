...
public class Symbol {
    ...
    public static Symbol magic = new Symbol("fonts/magic.png", 5,8);
    public static Symbol finesse = new Symbol("fonts/finesse.png", 5,8);
    public static Symbol force = new Symbol("fonts/force.png", 5,8);
    public static Symbol endurance = new Symbol("fonts/endurance.png", 5,8);
    public static Symbol stamina = new Symbol("fonts/stamina.png", 5,8);
    public static Symbol speed = new Symbol("fonts/speed.png", 5,8);
    public static Symbol critchance = new Symbol("fonts/critchance.png", 5,8);
    public static Symbol evasion = new Symbol("fonts/evasion.png", 5,8);
    public static Symbol lethality = new Symbol("fonts/lethality.png", 5,8);
