...
public class SkillInfo extends GUIElement {
    ...
    public int[] render() {
        ...
        int[] dmgOrHealPixels = getTextLine(dmgOrHealString, this.width-50, 10,
                TextAlignment.LEFT, Color.VOID, Color.WHITE);
        fillWithGraphicsSize(0, 8, this.width-50, 8, dmgOrHealPixels, false);

        String targetString = skill.getTargetString();
        int[] targetStringPixels = getTextLine(targetString, 50, 10,
                TextAlignment.RIGHT, Color.VOID, Color.WHITE);
        fillWithGraphicsSize(this.width-50, 9,50, 8, targetStringPixels, false);
