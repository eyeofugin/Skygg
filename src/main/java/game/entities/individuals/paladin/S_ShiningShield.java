...
public class S_ShiningShield extends Skill {
    ...
    public String getDescriptionFor(Hero hero) {
        return "Get a 15% Life shield that regenerates completely at the start of your turn until broken. Whenever damage is done to your shield, get that much favor";
    }
